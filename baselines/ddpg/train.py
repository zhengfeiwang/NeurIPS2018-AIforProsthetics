...
if __name__ == "__main__":
    ...
    while True:
        ...
        logger.debug('  sample time: {}'.format(train_result.info["sample_time_ms"] * train_result.timesteps_this_iter / 1000))
        logger.debug('  replay time: {}'.format(train_result.info["replay_time_ms"] * train_result.timesteps_this_iter / 1000))
        logger.debug('  gradient time: {}'.format(train_result.info["grad_time_ms"] * train_result.timesteps_this_iter / 1000))
        logger.debug('  update time: {}'.format(train_result.info["update_time_ms"] * train_result.timesteps_this_iter / 1000))
