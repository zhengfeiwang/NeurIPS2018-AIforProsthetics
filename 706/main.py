...
if __name__ == "__main__":
    ...
    parser.add_argument('--validation_interval', default=10, type=int, help='episode interval to validation')
    ...
    parser.add_argument('--max_episode_length', default=1000, type=int, help='maximum episode length')
